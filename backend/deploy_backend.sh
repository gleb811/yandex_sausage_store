...
sed -i "s/PSQL_SECRET_PASS_PSQL/${PSQL_PASSWORD}/g" sausage-store-backend.service
sed -i "s/PSQL_SECRET_PASS_MONGODB/${MONGODB_PASSWORD}/g" sausage-store-backend.service
